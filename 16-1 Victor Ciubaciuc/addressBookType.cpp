...
void addressBookType::addEntry(const extPersonType& eP){
...
bool addressBookType::deleteEntry(string lName){
    Node* currentNode = head;
    Node* previousNode = nullptr;
    
    while(currentNode != nullptr){
        if(currentNode -> person.getLastName() == lName){
            if(previousNode == nullptr){
                head = currentNode -> next;     //Delete next node
            }
            else{
